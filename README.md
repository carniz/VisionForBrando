# Vision för Brändö
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Kommunvapen_%C3%A5rsmodell_05.tif/lossless-page1-500px-Kommunvapen_%C3%A5rsmodell_05.tif.png" width="200" height=250" />
...
### Bo
För den som vill prova på att bo på Brändö är det ett stort steg i sig att bosätta sig på en ö längst ut i den Åländska skärgården. Att kräva eller förvänta sig att folk ur den tänkta målgruppen i ett initiellt skede ska göra en betydande investering för att köpa bostad eller mark för att sedan bygga sig en bostad ter sig relativt orealistiskt. De flesta skulle nog snarare se en flytt till Brändö ur ett "try (and then maybe buy)"-perspektiv, och för detta behövs det att det finns hyresbostäder.
...
I dag är det väl endast Lappo och Jurmo som kan erbjuda bra gästhamnar där allting finns inom gångavstånd. Brändö får ingen del av kakan, men om Brändö, Lappo och Jurmo erbjöd liknande gästhamnar så skulle det samlade värdet överstiga de enskilda värdena för respektive gästhamn: segelturister skulle se hela området som en enhet, och detta skulle skapa mervärde som gagnar alla tre öarna.
...
![Konferensrum 2](https://github.com/user-attachments/assets/f8d7f0cc-d568-4428-a742-86738aed7984)
...
## Skatteintäkter
En heltidsarbetande småföretagare i t.ex. IT-branschen omsätter utan problem mellan 100 och 150 tusen euro per år. Med en antagen bruttolön på 5000 per månad så skulle Brändös skatteintäkter öka med 885 euro per inflyttad och månad, givet en kommunalskatt på 17,7%. Skulle Brändö lyckas locka 10 familjer med 2 heltidsarbetande per familj att flytta sig själva och sina bolag till ön så skulle den årliga skatteintäkten öka med 212 400 (885 x 20 x 12) euro.
